...
**声明：本数据集旨在支持人工智能安全研究与评估。数据中的任何文本内容均不代表本项目团队的观点、态度或价值取向，使用者应遵守相关法律法规，并合理使用本数据集。**
...
## 🎯 贡献（**声明：本数据集旨在支持人工智能安全研究与评估。数据中的任何文本内容均不代表本项目团队的观点、态度或价值取向，使用者应遵守相关法律法规，并合理使用本数据集。**）

### 多民族语言平行指令数据集 ADML-Attacker
